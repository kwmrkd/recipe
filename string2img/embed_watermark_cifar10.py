...
def main():
    ...
    args.encoder_path   = "./models/encoder/encoder_16.pth"
    args.decoder_path   = "./models/decoder/decoder_16.pth"
    ...
    root_data_dir = "./datasets/uncompressed/cifar10/"
    image_outdir  = "./datasets/embedded/cifar10/images/"
    note_outdir   = "./datasets/embedded/cifar10/note/"
